...
int main()
{
	...
	std::cout << "\n\n########################################################\n";
	std::cout << "Running tests for C++ library ...." << std::endl;
	...
	std::cout << "[10] Testing cubemap2equirect method ..." << std::endl;
	mapper1.cubemap2equirect(cubemap,cv::Size (400,200), equiRect);
	...
	std::cout << "[11] Testing cubemap2equirect method for horizontal mode..." << std::endl;
	mapper1.cubemap2equirect(cubemap,cv::Size (400,200), equiRect);
	...
	std::cout << "[12] Testing cubemap2persp method for horizontal mode..." << std::endl;
	...
	std::cout << "[13] Testing cubemap2persp method for dice mode..." << std::endl;
	mapper1.cubemap2persp(cubemap,persp,90,0,0,400,400);
